...
Digit_Mapping_List = list(string.ascii_uppercase)

for digit in Digit_Mapping_List:
    path = image_Folder_Path + '\\' + digit
...
with open(csv_File_Path, newline='') as csvfile:
    ...
    for row in reader:
        ...
        if last_digit_Name != str(Digit_Mapping_List[(int)(digit_Name)]):
            last_digit_Name = str(Digit_Mapping_List[(int)(digit_Name)])
            count = 0
            print ("")
